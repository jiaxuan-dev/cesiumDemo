  ...
  >
    <div class="input">
      <!-- <div class="con">
        ...
        <el-button @click="setdata" plain>导入数据</el-button>
      </div>-->
      <div class="con">
        <el-select v-model="colorMapValue" placeholder="请先选择色带再点击开始">
          <el-option
...
export default {
  ...
  methods: {
    ...
    begin() {
      // var blob = new Blob([JSON.stringify(this.data), JSON.stringify(this.datasDes)], { type: '' })
      // saveAs(blob, 'cjl.json')
      this.mesh = new DynamicMesh(Viewer, { polygonPositons: meshData.data, des: meshData.datasDes, colorMap: this.colorMapValue })
