<template>
  ...
  >
    <div class="input">
      ...
      <div class="con">
        <el-select v-model="colorMapValue" placeholder="请选择">
          <el-option
...
export default {
  ...
  methods: {
    ...
    begin() {
      this.mesh = new DynamicMesh(Viewer, { polygonPositons: this.data, des: this.datasDes, colorMap: this.colorMapValue })
