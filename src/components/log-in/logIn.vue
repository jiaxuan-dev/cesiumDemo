<template>
  <div id="login">
    ...
    <div id="loginBox">
      <h3 style=" text-align: center; color: powderblue;">超维云</h3>
      <h4>系统登录</h4>
      <el-form :model="loginForm" :rules="loginRules" ref="loginForm" label-width="0px">
        ...
        <el-form-item label prop="passWord">
          <el-row>
            ...
            <el-col :span="22">
              <el-input class="inps" placeholder="密码" type="passWord" v-model="loginForm.passWord"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      //其他的校验逻辑
      //...
      if (this.loginForm.userName !== 'admin' || this.loginForm.passWord !== '123456789') return
...
#login {
  ...
  background-size: 100%;
  position: relative;
  background: url('./../../assets/image/Starry.jpg');
  #bgd {
    height: 100vh;
    width: 100vw;
    overflow: hidden;
